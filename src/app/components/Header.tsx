      ...
      <div className="bg-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10 text-sm">
            ...
            <div className="flex items-center space-x-4">
              <button className="hover:text-indigo-200">Customer Service</button>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <div className="flex-shrink-0">
                ...
                <p className="text-xs text-gray-500 hidden sm:block">Your trusted marketplace</p>
              </div>
            </div>
      ...
      <div className="bg-gray-50 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-6 overflow-x-auto h-12 text-sm">
            <button className="whitespace-nowrap hover:text-indigo-600 font-medium">Electronics</button>
            <button className="whitespace-nowrap hover:text-indigo-600 font-medium">Fashion</button>
            <button className="whitespace-nowrap hover:text-indigo-600 font-medium">Home & Kitchen</button>
            <button className="whitespace-nowrap hover:text-indigo-600 font-medium">Beauty</button>
            <button className="whitespace-nowrap hover:text-indigo-600 font-medium">Sports</button>
            <button className="whitespace-nowrap hover:text-indigo-600 font-medium">Books</button>
            <button className="whitespace-nowrap hover:text-indigo-600 font-medium">Toys</button>
          </nav>
        </div>
      </div>
      ...
      {showMobileMenu && (
        <div className="md:hidden bg-white border-b py-4">
          <div className="px-4 space-y-3">
            ...
            <button className="w-full text-left py-2 px-4 hover:bg-gray-100 rounded-lg">Orders</button>
            <button className="w-full text-left py-2 px-4 hover:bg-gray-100 rounded-lg">Wishlist</button>
            <button className="w-full text-left py-2 px-4 hover:bg-gray-100 rounded-lg">Customer Service</button>
          </div>
        </div>
      )}
    </header>
